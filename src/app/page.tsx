    ...
    <div className="relative mx-auto" style={{ width: 220 }}>
      <div className="relative bg-zinc-900 rounded-[2.5rem] border-4 border-zinc-700 shadow-2xl overflow-hidden" style={{ height: 420 }}>
        ...
        <div className="bg-[#0b141a] flex-1 px-3 py-2" style={{ backgroundImage: "radial-gradient(circle, rgba(255,255,255,0.02) 1px, transparent 1px)", backgroundSize: "20px 20px" }}>
          ...
          <ChatBubble text="which one?" isMe={true} time="13:02" />
          <ChatBubble text="the one about building a SaaS in 1 hour" isMe={false} time="13:02" />
          <ChatBubble text="bro that's actually fire" isMe={true} time="13:03" />
          <ChatBubble text="we should build one together" isMe={false} time="13:03" />
          <ChatBubble text="let's do it!" isMe={true} time="13:04" />
        </div>
        <div className="bg-[#1f2c34] px-3 py-2 flex items-center gap-2">
          <div className="flex-1 bg-[#2a3942] rounded-full px-3 py-1.5 text-[9px] text-[#8db4a8]">Message</div>
          <div className="w-6 h-6 rounded-full bg-[#00a884] flex items-center justify-center text-white text-[10px] font-bold">
            <svg width="10" height="10" viewBox="0 0 24 24" fill="white"><path d="M12 2a3 3 0 013 3v6a3 3 0 11-6 0V5a3 3 0 013-3z"/></svg>
          </div>
        </div>
      </div>
      ...
      <div className={`${bg} p-5 h-36 flex flex-col justify-between`}>
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex justify-end">
            <div className="bg-white/15 rounded-2xl rounded-br-sm px-3 py-1.5 text-white text-xs max-w-[70%]">Great, thanks!</div>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-zinc-950 text-white overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full px-4 py-1.5 mb-8 text-sm text-indigo-300">
              ...
              Free to use &middot; No design skills needed
            </div>
            ...
            <p className="text-xl text-zinc-400 leading-relaxed mb-10 max-w-lg">
              Create realistic animated chat conversations for TikTok, Reels &amp; Shorts &mdash; in under a minute.
            ...
            <div className="flex flex-wrap gap-3 mt-10 text-xs text-zinc-500">
              {['4 realistic themes', '3 aspect ratios', 'RTL language support', 'HD MP4 export'].map((f) => (
      ...
      <section id="how-it-works" className="py-28 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <Step n={1} icon="&#9998;" title="Write your script" desc="Type your conversation in plain text — Name: message. Add images, system messages, emoji reactions." />
            <Step n={2} icon="&#128065;" title="Preview in real time" desc="Watch your chat animate live in the editor. Adjust theme, speed, aspect ratio, background and more." />
            <Step n={3} icon="&#11015;" title="Export as MP4" desc="Render a crisp HD video ready to upload directly to TikTok, Instagram Reels, or YouTube Shorts." />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-zinc-500 max-w-xl mx-auto">
              Every pixel matches the real app &mdash; your audience won&apos;t be able to tell the difference.
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <ThemeCard icon="&#128172;" name="WhatsApp"  bg="bg-[#0b141a]" accent="bg-[#005c4b]" desc="The world's most recognized chat UI" />
            <ThemeCard icon="&#128172;" name="iMessage"  bg="bg-[#1c1c1e]" accent="bg-[#2b7fff]" desc="Apple's signature blue bubble style" />
            <ThemeCard icon="&#128248;" name="Instagram" bg="bg-gradient-to-br from-purple-950 to-pink-950" accent="bg-[#3797f0]" desc="DM style with gradient accents" />
            <ThemeCard icon="&#9992;" name="Telegram"   bg="bg-[#17212b]" accent="bg-[#2b5278]" desc="Clean and minimal messaging style" />
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-28 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <FeatureCard icon="&#127909;" title="Animated typing"       desc="Realistic typing indicators, read receipts, and message reveal animations for every theme." />
            <FeatureCard icon="&#127758;" title="RTL language support"  desc="Arabic, Hebrew, and other right-to-left languages display perfectly in every bubble." />
            <FeatureCard icon="&#128514;" title="Emoji reactions"       desc="Add WhatsApp-style reactions to any message. They show in both preview and exported video." />
            <FeatureCard icon="&#128444;" title="Image messages"        desc="Drop any image URL into your script. Images appear inside chat bubbles just like the real app." />
            <FeatureCard icon="&#127912;" title="Custom backgrounds"    desc="Choose a color, pick from presets, or use your own image as the chat background." />
            <FeatureCard icon="&#128241;" title="3 aspect ratios"       desc="9:16 for TikTok &amp; Reels, 1:1 for feed posts, 16:9 for YouTube — switch instantly." />
            <FeatureCard icon="&#9167;"  title="Keyboard animation"    desc="Show the iOS keyboard sliding up when Me is typing for extra realism." />
            <FeatureCard icon="&#128190;" title="Save your projects"    desc="Sign in to save unlimited projects and pick up exactly where you left off." />
            <FeatureCard icon="&#9889;"  title="Adjustable speed"      desc="Control how fast messages appear. Perfect for short punchy clips or longer storytelling." />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="relative bg-gradient-to-br from-indigo-950/60 to-purple-950/40 border border-indigo-500/20 rounded-3xl p-16 overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-5xl font-extrabold mb-6">Ready to go viral?</h2>
              ...
              >
                Start creating &mdash; it&apos;s free &rarr;
              </Link>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-zinc-800/50 py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-zinc-600">&copy; {new Date().getFullYear()} ChatVid. All rights reserved.</p>
